                ...
                <div className="col-12 col-lg-8">
                    <section className="mb-5">
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <button className="btn btn-link text-primary p-0 text-decoration-none small fw-bold d-flex align-items-center gap-1 transition-all hover-translate-x" onClick={() => navigate('/student/courses')}>
                        ...
                        <div className="row g-4">
                            {dashboardData.courses.length > 0 ? (
                                ...
                                <div className="col-12">
                                    <div className="card border-dashed p-5 text-center text-muted" style={{ background: 'var(--hover-bg)' }}>
                    ...
                    <section>
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            <h4 className="fw-bold m-0 text-body">Today's Schedule</h4>
                ...
                <div className="col-12 col-lg-4">
                    ...
                    <section className="mb-5">
                        <div className="d-flex align-items-center justify-content-between mb-4">
                            <h5 className="fw-bold m-0 text-body">Quick Actions</h5>
                        </div>
                    ...
                    <div className="card p-4 text-center rounded-4 border shadow-sm" style={{ background: 'var(--surface)' }}>
                        <p className="text-muted small mb-0 fw-medium">Join your scheduled sessions or check your courses for updates.</p>
                    </div>
                </div>
            </div>
        </div>
